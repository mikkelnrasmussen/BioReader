...
#BSUB -q hpc
### -- set the job Name -- 
#BSUB -J bioreader_infectious_disease
### -- ask for 1 core -- 
#BSUB -n 24
...
/usr/bin/time -v -o time/bioreader.time Rscript src/R/minimal_example.R -a Infectious_Disease -p --hpc -d _Infectious_Disease 
